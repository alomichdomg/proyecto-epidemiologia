...
interpretacion_anual <- paste(
  round(incidencia_por_año$tasa_de_incidencia_anual, 0),
  "de cada 100,000 habitantes tuvieron dengue durante 2025 en",
  incidencia_por_año$entidad_federativa
)
